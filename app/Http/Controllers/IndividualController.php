...
class IndividualController extends Controller
{
    ...
    {
        $ss = DB::table('shop_stewards')->orderBy('FullName','DESC')->get();
        $region = DB::table('regions')->orderBy('region_name','DESC')->get();
        $station = DB::table('stations')->orderBy('station_name','DESC')->get();
    ...
    public function edit($id)
    {
        ...
        $indi = DB::table('individuals')->where('id', $id)->first();
        ...
        //     ->first();
        //dd($do->AccHolderName);
        return view('edit', compact('indi', 'sp', 'oc', 'wc', 'ef', 'ib', 'tp', 'bn', 'pp','do','ss')); 
    }
  ...
  public function reportGen(){
        ...
        // ];
        $indi = DB::table('individuals')->get();
        $shopStewart = DB::table('shop_stewards')->orderBy('FullName', 'ASC')->get();
        $users = DB::table('users')->get();
        $stations = DB::table('stations')->get();
        $regions = DB::table('regions')->get();
        $province = DB::table('provinces')->get();
        return view('reportGen',compact('indi','shopStewart','users','regions','stations','province'));
    }
    public function downloadPDF2(Request $request){
        ...
        switch ($request->input('action')) {
            case 'ExportPDF':
                ...
                $statusFilterOne = $request->get('statusFilterOne');
                $startDate = $dates[0];
                $endDate = $dates[1];
                ...
                return $this->PDFGen($viewFilterOne,$ShopStewardFilterOne,$AgentFliterOne,$StationFliterOne,$RegionFliterOne,$premiumFilterOne,$startDate,$endDate,$indi,$statusFilterOne);
            ...
            case 'ExportCSV':
                ...
                return $this->xlsxGen($viewFilterOne,$statusFilterOne,$ShopStewardFilterOne,$AgentFliterOne,$StationFliterOne,$RegionFliterOne,$premiumFilterOne,$startDate,$endDate,$indi);
                break;
        }
    ...
    public function PDFGen($viewFilterOne,$ShopStewardFilterOne,$AgentFliterOne,$StationFliterOne,$RegionFliterOne,$premiumFilterOne,$startDate,$endDate,$indi,$statusFilterOne){
        $final = Individual::where([
            ['NewLead', 'LIKE',$indi],
            ['Status', 'LIKE',$statusFilterOne],
    ...
    public function xlsxGen($viewFilterOne,$ShopStewardFilterOne,$AgentFliterOne,$StationFliterOne,$RegionFliterOne,$premiumFilterOne,$startDate,$endDate,$indi,$statusFilterOne){
