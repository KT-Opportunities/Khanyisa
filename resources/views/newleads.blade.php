    ...
    <div class="row">
        <div class="col-md-12"><h6>PRINCIPAL MEMBER DETAILS</h6></div>
            ...
            <div class="col-md-6"> 
                ...
                <option value="D: R19 000">D: R19 000</option>
                <option value="E: R30 000">E: R30 000</option>
                <option value="F: R50 000">F: R50 000</option>
                <option value="G: R75 000">G: R75 000</option>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="formControl" name="CellNumber"/>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <option selected value="{{$contact->name}}">{{$contact->name}}</option>
                @endforeach
                </select>
            </div>
            <div class="col-md-6">
                ...
                <option selected value="{{$contact->FullName}}">{{$contact->FullName}}</option>
                @endforeach
                </select>
            </div>
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                ...
                <input type="number" required class="formControl" name="MainIDNumber" maxlength="13" id="MainIDNumber" minlength="13"/>
            </div>
            <div class="col-md-6">
                <label for="MainAge">Age :</label>
                <input type="text" class="formControl" name="MainAge" id="MainAge" readonly/>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="formControl" name="MainWorkNumber"/>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="formControl" name="MainEmail"/>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="formControl" value="KIP" name="PolicyNum"/>
            </div>
            <div class="col-md-12">
          ...
          <div class="block" id="step2">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber1" class="formControl" maxlength="13" id="IDNumber1"><p class="tinytxt">Too old</p></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber2" class="formControl" maxlength="13" id="IDNumber2"><p class="tinytxt">Too old</p></td>
                                            <td><label class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber3" class="formControl" maxlength="13" id="IDNumber3"><p class="tinytxt">Too old</p></td>
                                            <td><label class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber4" class="formControl" maxlength="13" id="IDNumber4"><p class="tinytxt">Too old</p></td>
                                            <td><label class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber5" class="formControl" maxlength="13" id="IDNumber5"><p class="tinytxt">Too old</p></td>
                                            <td><label class="container">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" name="IDNumber6" class="formControl" maxlength="13" id="IDNumber6"><p class="tinytxt">Too old</p></td>
                                            <td><label class="container">
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><input type="number" name="WIDNumber1" class="formControl" maxlength="13" id="WIDNumber1"><p class="tinytxt">Too old</p></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="WIDNumber2" class="formControl" maxlength="13" id="WIDNumber2"><p class="tinytxt">Too old</p></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="WIDNumber3" class="formControl" maxlength="13" id="WIDNumber3"><p class="tinytxt">Too old</p></td>
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" name="WIDNumber4" class="formControl" maxlength="13" id="WIDNumber4"><p class="tinytxt">Too old</p></td>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><input type="number" name="FIDNumber1" class="formControl" maxlength="13" id="FIDNumber1"></td>
                                            <td><label class="container">
                                            ...
                                            <td hidden><input type="text" name="FWaitingPeriod1" readonly id="FWaitingPeriod1"></td>
                                        </tr>
                                        <tr>
                                        <td><input type="text" name="FName2" class="formControl"></td>
                                            
                                            <td><input type="number" name="FIDNumber2" class="formControl" maxlength="13" id="FIDNumber2"></td>
                                            <td><label class="container">
                                            ...
                                            <td hidden><input type="text" name="FWaitingPeriod2" readonly id="FWaitingPeriod2"></td>
                                        </tr>
                                        <tr>
                                        <td><input type="text" name="FName3" class="formControl"></td>
                                            
                                            <td><input type="number" name="FIDNumber3" class="formControl" maxlength="13" id="FIDNumber3"></td>
                                            <td><label class="container">
                                            ...
                                            <td hidden><input type="text" name="FWaitingPeriod3" readonly id="FWaitingPeriod3"></td>
                                        </tr>
                                        <tr>
                                        <td><input type="text" name="FName4" class="formControl"></td>
                                            
                                            <td><input type="number" name="FIDNumber4" class="formControl" maxlength="13" id="FIDNumber4"></td>
                                            <td><label class="container">
                                            ...
                                            <td hidden><input type="text" name="FWaitingPeriod4" readonly id="FWaitingPeriod4"></td>
                                        </tr>
                                        <tr>
                ...
                <div class="block" id="step3">
                    ...
                    <div class="col-md-12"><div class="btn" id="prev2" onClick="showstep2()">Prev Step</div></div>
                        ...
                        <div class="col-md-6">
                                <label>ID NUMBER: </label>
                                <input type="number" name="BIDNumber" class="formControl" maxlength="13">
                            </div>
                        <div class="col-md-6">
                ...
                <div class="block" id="step4">
                    ...
                    <div class="col-md-12"><div class="btn" id="prev3" onClick="showstep3()">Prev Step</div></div>
                        ...
                        <div class="col-md-6">
                                ...
                                <input type="text" name="PIDNumber" class="formControl">
                            </div>
                        <div class="col-md-6">
   ...
   document.getElementById('update').addEventListener("click",function(){
       console.log("FUCKCUCJFIJFDJUFJM");
        ...
        document.getElementById('SchemeOption').addEventListener("click",function(){
            ...
            document.getElementById('FCovAm1').addEventListener('click', function(){ getExtendedFamilyPreimium("FIDNumber1",this.id,"FUMN1","FPrem1","FRep1","FTotalPre1","FWaitingPeriod1")});
            document.getElementById('FCovAm2').addEventListener('click', function(){ getExtendedFamilyPreimium("FIDNumber2",this.id,"FUMN2","FPrem2","FRep2","FTotalPre2","FWaitingPeriod2")});
            document.getElementById('FCovAm3').addEventListener('click', function(){ getExtendedFamilyPreimium("FIDNumber3",this.id,"FUMN3","FPrem3","FRep3","FTotalPre3","FWaitingPeriod3")});
            document.getElementById('FCovAm4').addEventListener('click', function(){ getExtendedFamilyPreimium("FIDNumber4",this.id,"FUMN4","FPrem4","FRep4","FTotalPre4","FWaitingPeriod4")});                                
            ...
            document.getElementById('OPone').addEventListener('click', function(){
                if(document.getElementById('OPone').checked){
                    document.getElementById('Airtime').value = parseFloat(7.60).toFixed(2);
                    GrandestGrandTotal();
                }else{
            ...
            document.getElementById('OPtwo').addEventListener('click', function(){
                if(document.getElementById('OPtwo').checked){
                    document.getElementById('Car').value =parseFloat(34.10).toFixed(2);
                    GrandestGrandTotal();
                }else{
           ...
           switch(document.getElementById('SchemeOption').value)
            {
                case "A: R8 000":
                var x = 31.10;
                document.getElementById('MainPremium').value = parseFloat(x).toFixed(2);
        ...
        function addMainUMNGCWABO(){
            ...
            if(x.checked == true && y.checked == true){
                document.getElementById('MainPremium').value = parseFloat(35.85 + z).toFixed(2);
                document.getElementById('SPPremium').value = parseFloat(35.85 + z).toFixed(2);
            }else if(x.checked == false && y.checked == true){
                document.getElementById('MainPremium').value = parseFloat(22.80 + z).toFixed(2);
                document.getElementById('SPPremium').value = parseFloat(22.80 + z).toFixed(2);
        ...
        function getAgeValidation(x,y,z){
            ...
            var age = (d8.getYear() - document.getElementById(y).value.substring(0, 2)).toString().slice(-2);
                if(age >= 14 && age <= 21){
                    ...
                    document.getElementById(y).parentElement.childNodes[1].style.display = "none";
                }else{
                    document.getElementById(x).disabled = true;
                    console.log("not in age gap:"+age );
                    document.getElementById(y).style.border = "2px solid #F97D7D";
                    document.getElementById(y).parentElement.childNodes[1].style.display = "block";
                }
        }
        ...
        function  ValidateWiderAge(x,y){
            ...
            if(a >= 0 && a <= 5 ){
                document.getElementById(x).value = parseFloat(7.00).toFixed(2);
                document.getElementById(y).style.border = "0";
                document.getElementById(y).parentElement.childNodes[1].style.display = "none";
                    console.log("1 gap");
            }else  if(a >= 6 && a <= 13 ){
                ...
                document.getElementById(x).value = parseFloat(0.00).toFixed(2);
                document.getElementById(y).parentElement.childNodes[1].style.display = "block";
                document.getElementById(y).style.border = "2px solid #F97D7D";
        ...
        function getExtendedFamilyPreimium(x,y,z,a,b,c,d){
            var total = 0;
            console.log("getExtendedFamilyPreimium(x,y,z,a,b,c) called");
            var age = ExtendedFamilyAge(x);
            console.log("got age: "+age);
            if(age < 74){
                document.getElementById(d).value = "6 months";
            }else{
                document.getElementById(d).value = "12 months";
            }
        ...
        function getExtendedFamilyPreimiumTotal(x,total){
            // x is the loctaion
            //you know total
            document.getElementById(x).value = parseFloat(total).toFixed(2);
        ...
        function getExtendedFamilyPreimiumGrandTotal(){
            ...
            if(document.getElementById("FTotalPre1").value != ""){
                    total += Number(document.getElementById("FTotalPre1").value).toFixed(2);
            }
            if(document.getElementById("FTotalPre2").value != ""){
                total += Number(document.getElementById("FTotalPre2").value).toFixed(2);
            }
            if(document.getElementById("FTotalPre3").value != ""){
                total += Number(document.getElementById("FTotalPre3").value).toFixed(2);
            }
            if(document.getElementById("FTotalPre4").value != ""){
                total += Number(document.getElementById("FTotalPre4").value).toFixed(2);
            }
            
            document.getElementById("FTotalPrem").value = parseFloat(total).toFixed(2);
        ...
        function widerChildernTotal(){
            ...
            document.getElementById('WTotalPre').value = parseFloat(total).toFixed(2);
        }
        function TotalImmediateFamilyFuneralPremium(){
            if(document.getElementById('TotalPreminum').value == ""){
                ...
                document.getElementById('TotalFamily').value = Number(document.getElementById('MainPremium').value).toFixed(2);
            }else{
                console.log("that first total: "+document.getElementById('TotalPreminum').value);
                document.getElementById('TotalFamily').value = Number(document.getElementById('MainPremium').value).toFixed(2) + Number(document.getElementById('TotalPreminum').value).toFixed(2);
            }
            GrandestGrandTotal();
        }
        ...
        function ExtendedFamilyPremium(){
            document.getElementById('Extended').value = parseFloat(document.getElementById("FTotalPrem").value).toFixed(2);
            GrandestGrandTotal();
        }
        function getINCOMECONTINUATIONBENEFIT(){
            if(document.getElementById('BPMone').checked){
                document.getElementById('InCon').value = parseFloat(10.90).toFixed(2);
            }else if(document.getElementById('BPMtwo').checked) {
                document.getElementById('InCon').value = parseFloat(21.80).toFixed(2);
            }else if(document.getElementById('BPMthree').checked) {
                document.getElementById('InCon').value = parseFloat(32.70).toFixed(2);
            }else if(document.getElementById('BPMfour').checked) {
                document.getElementById('InCon').value = parseFloat(43.60).toFixed(2);
            }
            GrandestGrandTotal();
        ...
        function GrandestGrandTotal(){
            ...
            if(document.getElementById('TotalFamily').value != ""){
                total += Number(document.getElementById('TotalFamily').value).toFixed(2);
            }
            if(document.getElementById('Wider').value != ""){
                total += Number(document.getElementById('Wider').value).toFixed(2);
            }
            if(document.getElementById('Extended').value != ""){
                total += Number(document.getElementById('Extended').value).toFixed(2);
            }
            if(document.getElementById('InCon').value != ""){
                total += Number(document.getElementById('InCon').value).toFixed(2);
            }
            if(document.getElementById('Airtime').value != ""){
                total += Number(document.getElementById('Airtime').value).toFixed(2);
            }
            if(document.getElementById('Car').value != ""){
                total += Number(document.getElementById('Car').value).toFixed(2);
            }
            document.getElementById('GrandTotal').value = parseFloat(total).toFixed(2);
            document.getElementById('PAmount').value = parseFloat(total).toFixed(2);
            document.getElementById('AccAmount').value = parseFloat(total).toFixed(2);
