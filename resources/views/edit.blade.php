...
<div class="col-md-12 PrevNextEdit">
    <div style="cursor: pointer;" id="Next">Next</div>
    <div style="cursor: pointer;" id="Prev1">Prev</div>
    <div style="cursor: pointer;" id="Next1">Next</div>
    <div style="cursor: pointer;" id="Prev2">Prev</div>
    <div style="cursor: pointer;" id="Next2">Next</div>
    <div style="cursor: pointer;" id="Prev3">Prev</div>
    ...
    <div style="cursor: pointer;" id="generatePDF"><a href="{{ url('/downloadPDF',$indi->id) }}" ><img src="{{ asset('img/Page-1.svg') }}"> Generate Certificate</a></div>
</div>
    <div class="col-md-12">
            ...
            <li><a href="#communicationCommunication" data-toggle="tab" aria-selected="false" onclick="viewComms()">Communication</a></li>
                ...
                <div class="block" id="step2">
                    <div class="row">
                                ...
                                <table>
                                    ...
                                    @foreach($oc as $data)
                                        <tr>
                                            ...
                                            <td>
                                                <label  class="container2" for="check1">
                                                    <input type="checkbox" name="check1" checked class="formControl" value="yes">
                        ...
                        <div class="col-md-12">
                                <table id="EXTENDED_FAMILY_DETAILS">
                                    <thead>
                                        <tr>
                                            <td>Name:</td>
                                    ...
                                    @foreach($ef as $dataa)
                                        <tr>
                                            ...
                                            <td><input type="text" name="FIDNumber1" value="{{$dataa->IDNumber}}" disabled  class="formControl" onkeyup="calcWaitingPeriod(this)"></td>
                                            ...
                                            <td hidden><input type="text" name="FWaitingPeriod1" value="hello" disabled  class="formControl"></td>
                                        </tr>
        ...
        <div class="statusModalContent" id="statusModalContent">
            <div class="row">
                ...
                <form class="" method="POST" action="/status">
                    ...
                    <input type="text"  disabled name="Indi_id" value="{{$indi->id}}" id="doc">
                </div>
                    <div class="col-md-6">
                        <label>Status Comment:</label>
                        <textarea name="StatusComment" class="formControl" maxlength="300"></textarea>
                    </div>
                    <div class="col-md-12">
                ...
                <!-- <div class="col-md-12">
                    <div class="greyBlockWrapper">
                        <div class="greyBlock">
                            <p>So i changed the status to active </p>
                            <p class="NameTime"><b>Dawn Chikoki,   Tue, 25-02-2020 11:07 AM</b></p>
                        </div>
...
document.getElementById('Prev3').addEventListener("click", function(){
    ...
    function newLeadpopup(){
        ...
        function calcAge(x){
            ...
            var a,z = "";
            var d8 = new Date();
            z = parseInt(d8.getYear()) - parseInt(x.substring(0, 2));
            a = z.toString().slice(-2);
            age = Number(a);
            return age;
        }
        function calcWaitingPeriod(x){
            var age = calcAge(x.value);
           var td = x.parentNode.parentNode.getElementsByTagName("td")[7].childNodes[0].value;
           if(age <= 74){
               td = "6 months";
           }else{
            td = "12 months";
