...
<sidenav>
        ...
        <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                    <div class="block">
                        <button class="viewDetailsBTN"><a href="{{ url('/reportGen','NLvsI') }}">View details</a></button>
                        <canvas id="myChart" height="70"></canvas>
                    </div>
                    </div>
                    <div class="col-md-4">
                    <div class="block">
                    <button class="viewDetailsBTN"><a href="{{ url('/reportGen','Statuses') }}">View details</a></button>
